        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-primary-foreground/80 text-sm leading-relaxed">
              Your trusted source for premium quality dogs and puppies.
              We are committed to connecting you with healthy,
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <a
                href="https://www.facebook.com/share/1AiWETnaFF/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 hover:text-primary-foreground/80 transition-colors"
              >
              ...
              <div className="flex items-start gap-2 text-primary-foreground/80">
                ...
                <span>
                  Plot no. 345, Shop no. 102, Near V. V. Shopprix Complex,
